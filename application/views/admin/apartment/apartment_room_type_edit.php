              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo $this->lang->line($room_type_edit['room_type']); ?>
                    </li>
                  </ol>
                </div>
              </div>
...
<section id="basic-input" >
    <form class="text-center" action="<?=base_url('admin/apartment_room_type_update/')?><?php echo $room_type_edit['code'];?>" method="POST">
  <div class="row">
    <div class="col-md-12">
      <div class="card">
          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="form-group">
               ...
               <select class="form-control" id="room_type" name="room_type">
                    <option value="<?php echo $room_type_edit['room_type'];?>"><?php echo $this->lang->line($room_type_edit['room_type']); ?></option>
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="form-group">
				...
				<input type="number" class="form-control" name="single_bed"  min="0" required id="single_bed" placeholder="<?=$this->lang->line('single bed');?>" value="<?php echo $room_type_edit['single_bed'];?>">
              </div>
            </div>
            <div class="col-xl-4 col-md-6 col-12">
              <div class="form-group">
                <label for="double_bed" class=""><?=$this->lang->line('double bed');?>:</label>
				<input type="number" class="form-control" name="double_bed"  min="0" required id="double_bed" placeholder="<?=$this->lang->line('double bed');?>" value="<?php echo $room_type_edit['double_bed'];?>">
              </div>
            </div>
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="form-group">
               ...
               <select class="form-control" id="heating" name="heating">
                   <option value="<?php echo $room_type_edit['heating'];?>" selected="selected"><?php echo $this->lang->line($room_type_edit['heating']);?></option>
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="form-group">
				...
				<input type="number" class="form-control" name="area" required id="area" placeholder="<?=$this->lang->line('Area');?>" value="<?php echo $room_type_edit['area'];?>">
              </div>
            </div>
            <div class="col-xl-4 col-md-6 col-12 mb-1">
              <div class="form-group">
                ...
                <select name="currency">
                    <option value="<?php echo $room_type_edit['currency'];?>" selected="selected"><?php echo $room_type_edit['currency'];?></option>
					<option value="GEL" selected="selected">GEL</option>
					<option value="USD">USD</option>
					<option value="EUR">EUR</option>
											</select>
					<input type="number" id="price" name="price"  class="form-control" placeholder="<?=$this->lang->line('Price');?>" required value="<?php echo $room_type_edit['price'];?>">
              </div>
            </div>
            <div class="col-xl-4 col-md-6 col-12 mb-1">
              <div class="form-group">
                <label for="price_with_breakfast"><?=$this->lang->line('Price');?> <?=$this->lang->line('with breakfast');?></label>
                <input type="number" id="price_with_breakfast" name="price_with_breakfast"  class="form-control" placeholder="<?=$this->lang->line('Price');?> <?=$this->lang->line('with breakfast');?>" min="0" required value="<?php echo $room_type_edit['price_with_breakfast'];?>">
              </div>
            </div>
          </div>
	                                    ...
	                                    <table cellspacing="0" cellpadding="0">
	                                    	   <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="rom_service" name="room_service" value="1" <?php if($room_type_edit['room_service'] == '1') { echo 'checked';}?>>
                                	            ...
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="tv" name="tv" value="1" <?php if($room_type_edit['tv'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	             <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="wifi" name="wifi" value="1" <?php if($room_type_edit['wifi'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="furniture" name="furniture" value="1" <?php if($room_type_edit['furniture'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="closet" name="closet" value="1" <?php if($room_type_edit['closet'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	             <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="air_conditioner" name="air_conditioner" value="1" <?php if($room_type_edit['air_conditioner'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="refrigerator" name="refrigerator" value="1" <?php if($room_type_edit['refrigerator'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="iron" name="iron" value="1" <?php if($room_type_edit['iron'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="hair_dryer" name="hair_dryer" value="1" <?php if($room_type_edit['iron'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
	                                    ...
	                                    <table cellspacing="0" cellpadding="0">
	                                            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="washing_machine" name="washing_machine" value="1" <?php if($room_type_edit['washing_machine'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="bar" name="bar" value="1" <?php if($room_type_edit['bar'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="kitchen" name="kitchen" value="1" <?php if($room_type_edit['kitchen'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="dining_table" name="dining_table" value="1" <?php if($room_type_edit['dining_table'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="balcony" name="balcony" value="1" <?php if($room_type_edit['balcony'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="sea_view" name="sea_view" value="1" <?php if($room_type_edit['sea_view'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="mountain_view" name="mountain_view" value="1" <?php if($room_type_edit['mountain_view'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            ...
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="separate_bathroom" name="separate_bathroom" value="1" <?php if($room_type_edit['separate_bathroom'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                	                    <input id='separate_toilet' type='hidden'  name="separate_toilet" value="0">
                                                        <input type="checkbox" id="separate_toilet" name="separate_toilet" value="1" <?php if($room_type_edit['separate_toilet'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div action="<?=base_url('admin/apartment_room_type_upload/')?><?php echo $room_type_edit['code'].'/'.$room_type_edit['apartment_code']; ?>" class="dropzone dropzone-area clickable" id="dpz-multiple-files">
  ...
  <div class="dropdown-content">
      ...
      <a href="<?=base_url('admin/delete_apartment_room_type_image/')?><?php echo $images_item['file_name']; ?>/<?php echo $images_item['code']; ?>"><?=$this->lang->line('Delete');?></a>
