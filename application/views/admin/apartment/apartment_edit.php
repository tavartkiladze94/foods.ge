...
<?php if ($this->session->has_userdata('message')): ?>
    <div id="message" style="position: absolute; top: 80px;right:50px; border: 1px solid #55b536; height:40px; text-align:center; background:#55b536; padding: 10px 10px;"> 
        <h6 style="color:white!important; font-size:16px;"><i class="fa fa-check" style="font-size:18px; color:white!important;"></i> <?=$this->lang->line('record successfully added');?></h6>
    </div>
<script>
              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo $this->lang->line($apartment_edit['category'])." ". $this->lang->line($apartment_edit['type']);?>
                    </li>
                  </ol>
                </div>
              </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            ...
            <select class="form-control" id="type" name="type" <?php if($apartment_edit['status'] == 'Active') echo 'disabled="disabled"';?>>
            ...
            <div class="col-xl-4 col-md-6 col-12 mb-1">
              <div class="form-group">
               ...
               <select class="form-control" id="category" name="category" <?php if($apartment_edit['status'] == 'Active') echo 'disabled="disabled"';?>>
            ...
            <div class="col-xl-4 col-md-6 col-12 mb-1">
              <div class="form-group">
               ...
               <select class="form-control" id="country" name="country" <?php if($apartment_edit['status'] == 'Active') echo 'disabled="disabled"';?>>
            ...
            <div class="col-xl-4 col-md-6 col-12 ">
              <div class="form-group">
               ...
               <select class="form-control" id="region" name="region" <?php if($apartment_edit['status'] == 'Active') echo 'disabled="disabled"';?>>
            ...
            <div class="col-xl-4 col-md-6 col-12 ">
              <div class="form-group">
               ...
               <select class="form-control" id="municipality" name="municipality" <?php if($apartment_edit['status'] == 'Active') echo 'disabled="disabled"';?>>
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control"  name="city" id="city" placeholder="<?=$this->lang->line('City');?>/<?=$this->lang->line('Village');?>" value="<?php echo $apartment_edit['city'];?>" required <?php if($apartment_edit['status'] == 'Active') echo 'disabled="disabled"';?>>
              </div>
            </div>
            <div class="col-xl-4 col-md-6 col-12">
              <div class="form-group">
                <label for="address" class=""><?=$this->lang->line('Address');?>:</label>
                <input type="text" class="form-control"  name="address" id="address" placeholder="<?=$this->lang->line('Address');?>" value="<?php echo $apartment_edit['address'];?>" required  <?php if($apartment_edit['status'] == 'Active') echo 'disabled="disabled"';?>>
              </div>
            </div>
            <div class="col-xl-4 col-md-6 col-12">
              <div class="form-group">
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="form-group">
				...
				<input type="number" class=" form-control" min="1" id="floor" name="floor" value="<?php echo $apartment_edit['floor'];?>" <?php if($apartment_edit['status'] == 'Active') echo 'disabled="disabled"';?>>
              </div>
            </div>
            <div class="col-xl-4 col-md-6 col-12">
              <div class="form-group">
                <label for="area" class=""><?=$this->lang->line('Area');?> - <?=$this->lang->line('M');?> <sup>2</sup>:</label>
				<input type="number" class="form-control" name="area" min="0" required id="area" placeholder="<?=$this->lang->line('Area');?>" value="<?php echo $apartment_edit['area'];?>" <?php if($apartment_edit['status'] == 'Active') echo 'disabled="disabled"';?>>
              </div>
            </div>
	                                    	   ...
	                                    	   <tr>
                                	            ...
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="dining_table" name="dining_table" value="1" <?php if($apartment_edit['dining_table'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                    ...
                                    <div class="div_table" > 
	                                    <table cellspacing="0" cellpadding="0">
                                	            ...
                                	            <tr>
                                                    ...
                                                    <input type="checkbox" id="to_sea" name="to_sea" value="1" <?php if($apartment_edit['to_sea'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            ...
                                	            <tr>
                                                    ...
                                                    <input type="checkbox" id="to_airport" name="to_airport" value="1" <?php if($apartment_edit['to_airport'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="sea_view" name="sea_view" value="1" <?php if($apartment_edit['sea_view'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="mountain_view" name="mountain_view" value="1" <?php if($apartment_edit['mountain_view'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            ...
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="payment_cash" name="payment_cash" value="1" <?php if($apartment_edit['payment_cash'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
                                	            <tr>
                                	                ...
                                	                <td><label class="containeri">
                                                        ...
                                                        <input type="checkbox" id="payment_card" name="payment_card" value="1" <?php if($apartment_edit['payment_card'] == '1') { echo 'checked';}?>>
                                                        <span class="checkmark"></span>
                                                        </label>
                                                    </td>
                                	            </tr>
...
<br>
<br>
<section id="basic-datatable" <?php if(($apartment_edit['type'] == 'House') || ($apartment_edit['type'] == 'Hotel') || ($apartment_edit['type'] == 'Guest_hotel')  || ($apartment_edit['type'] == 'Cottage')) echo 'style="display: block;"'; else { 
    echo 'style="display: none;"';}?>>
    <div class="card-datatable table-responsive pt-0" style="background-color:white;">
        <div class="dt-buttons btn-group flex-wrap"><button class="btn add-new btn-primary mt-50"  type="button" data-toggle="modal" ><span> <a href="<?=base_url('admin/apartment_room_type_create');?>/<?php echo $apartment_edit['code'];?>" style="color:white;"><?=$this->lang->line('Add room type');?></a></span></button> 
        </div>
        <br>
        <br>
    </div>
          ...
          <tbody>
              <?php $r=1;?>
									...
									<tr role="row" class="odd">
									    <td> <?php echo $r;?></td>	
										<td><a href="<?=base_url('admin/apartment_room_type_edit/');?><?php echo $apartment_item['code']; ?>" style="color: #007bff;"><?php echo $this->lang->line($apartment_item['room_type']); ?></a></td>
										<td><a href="<?=base_url('admin/user_apartment_room_type_delete/');?><?php echo $apartment_item['code']; ?>" style="color:red;">
