              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?=base_url('admin/apartments_bookings_list');?>"><?=$this->lang->line('Booking');?></a>
                    </li>
...
<section id="basic-datatable">
   ...
   <br>
      ...
      <h2><?=$this->lang->line('Quantity');?> - <?php echo $rooms_bookings_list_length; ?></h2>
      <div class="card" style="overflow-x:scroll;">
        <table class="datatables-basic table">
          ...
          <tbody>
             <?php $r=1;?>
			<?php if (!empty($rooms_bookings_list)) foreach ($rooms_bookings_list as $booking_item): ?>
			<tr role="row" class="odd">
				...
				<td><a href="<?=base_url('admin/booking_delete/');?><?php echo $booking_item['code']; ?>" style="color:red;">
