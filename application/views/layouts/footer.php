<div id="fb-customer-chat" class="fb-customerchat">
 ...
 <script>
      ...
      chatbox.setAttribute("page_id", "247186895408714");
      ...
      for (i = 0; i < arr.length; i++) {
        ...
        if (arr[i].name.substr(0, val.length).toUpperCase() == val.toUpperCase()) {
          ...
          b.addEventListener("click", function(e) {
              ...
              location.href = "<?=base_url('main/foods_info/');?>"+ this.getElementsByTagName("input")[1].value;
...
var foods_search =[];
<?php if (!empty($foods_all))  foreach ($foods_all as $food_item): ?>
/*An array containing all the country names in the world:*/
 var aaa= {code: "<?php echo $food_item['code'];?>", name: "<?php echo $food_item['name_'.$this->lang->line('lan')];?>"} ;
...
<script src="<?=base_url();?>assets/js/main.js"></script>
 <!-- TOP.GE ASYNC COUNTER CODE -->
            <div id="top-ge-counter-container" data-site-id="117057"></div>
